...
const Dashboard = {
  ...
  _populateDetailTransactionToModal(transactionRecord) {
    ...
    const createDetailRecord = document.querySelector('#recordDetailModal #createDetailRecord');
    const updateDetailRecord = document.querySelector('#recordDetailModal #updateDetailRecord');
    ...
    createDetailRecord.textContent = transactionRecord.createdAt.toDate();
    updateDetailRecord.textContent = transactionRecord.updatedAt.toDate();
  },

  _templateBodyTable(index, transactionRecord) {
    console.log(transactionRecord.date.toDate())
    return `
      <tr>
